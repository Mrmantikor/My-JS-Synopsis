 ...
 * - Корисно для гнучкості: обробки даних, створення функцій "на льоту" чи роботи з асинхронністю.
*/
TODO: Синтаксис:
  Приймає функцію як аргумент
function ім’я(callback) {
...
/*
TODO: Приклад 1. Приймає колбек
function doWithCallback(action) {
  console.log('Починаємо...');
  action(); // Викликаємо передану функцію
}
doWithCallback(() => console.log('Готово!')); // Виводить: 'Починаємо...' і 'Готово!'

TODO: Приклад 2. Повертає функцію
function createGreeter() {
  return (name) => console.log(`Привіт, ${name}!`);
}
const greet = createGreeter();
greet('Anna'); // Виводить: 'Привіт, Anna!'

TODO: Приклад 3. Комбінація: приймає і повертає
function multiplyBy(factor) {
  return (number) => number * factor; // Повертаємо функцію
}
const double = multiplyBy(2); // Передаємо 2 як factor
console.log(double(5)); // Виводить: 10
*/
//#endregion
