 ...
 * - `значення1 === значення2` — порівнює лівий і правий операнди за значенням і типом.
 * - Якщо типи даних різні, повертає false без приведення типів.
 * - Якщо типи однакові, порівнює значення: true при повній ідентичності, інакше false.
 * - Не виконує примусове приведення типів (на відміну від ==).
 * - Корисно для точного порівняння, коли тип даних важливий.
