...
console.log('До запуска циклу');

for (let i = 0; i < 10; i++) {
  console.log('До break');
  break; // Цикл зупиняється одразу на першій ітерації
  console.log('Тут стався break');
}

console.log('По за циклом'); Виводить: 'До запуска циклу', 'До break', 'По за циклом'
...
console.log('До запуска циклу');
for (let i = 0; i < 10; i++) {
  console.log('До continue');
  if (i % 2 !== 0) {
    continue; // Пропускає непарні числа
  }
  console.log(`Парне число: ${i}`);
};
console.log('По за циклом'); 

TODO: Приклад 2. Пропуск у циклі while
let num = 0;
console.log('До запуску циклу while');
while (num < 5) {
  num++;
  console.log('До continue');
  if (num === 3) {
    continue; // Пропускає ітерацію, коли num === 3
  }
  console.log(`Значення: ${num}`);
};
console.log('По за циклом');
...
for (let i = 0; i <= 20; i++) {
  if (i % 4 === 0) {
    ...
    continue; // Пропускає числа, кратні 4
  }
  let square = i * i;
