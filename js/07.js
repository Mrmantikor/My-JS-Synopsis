...
TODO: Створює новий масив, копіюючи частину елементів із старого масиву за вказаними індексами.
 * - array.slice(start, end) — метод масиву, який повертає новий масив із вибраними елементами.
 * - start — індекс, із якого почати копіювання (включно).
 * - end — індекс, до якого копіювати (не включно, необов’язковий).
 * - Не змінює оригінальний масив, а створює новий із вибраною частиною.
 * - Корисно для витягнення шматка масиву, наприклад, перших кількох елементів чи діапазону.
...
console.log(part); // Виводить: [2, 3, 4] (від індексу 1 до 4, не включно)
console.log(numbers); // Виводить: [1, 2, 3, 4, 5] (оригінал не змінився)

let names = ['josh', 'anna', 'bob', 'emma'];
let firstTwo = names.slice(0, 2);
console.log(firstTwo); // Виводить: ['josh', 'anna'] (перші два елементи)

let fruits = ['apple', 'banana', 'kiwi'];
let fromSecond = fruits.slice(1);
console.log(fromSecond); // Виводить: ['banana', 'kiwi'] (від індексу 1 до кінця)
*/
