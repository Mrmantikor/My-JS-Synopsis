...
*/
/* //! slice() (Витягнення частини рядка або масиву)
TODO: Повертає новий рядок або масив, що містить вибрану частину оригінального рядка чи масиву.
 * - Метод рядків і масивів, який витягує підмножину елементів від початкового індексу до кінцевого (не включно).
 * - Приймає два необов’язкові аргументи: start (початковий індекс) і end (кінцевий індекс, необов’язковий).
 * - Не змінює оригінальний рядок чи масив (повертає копію).
 * - Якщо аргументи не вказані, повертає повну копію; підтримує від’ємні індекси (рахунок із кінця).

TODO: Приклад із рядком
const str = 'Hello, World!';
console.log(str.slice(0, 5)); // Виведе: 'Hello' (від 0 до 5, не включно)

TODO: Приклад із масивом
const arr = [1, 2, 3, 4, 5];
console.log(arr.slice(1, 3)); // Виведе: [2, 3] (від 1 до 3, не включно)

TODO: Приклад із від’ємними індексами
const text = 'JavaScript';
console.log(text.slice(-6, -1)); // Виведе: 'Scrip' (від 6-го з кінця до 1-го з кінця)

TODO: Приклад без кінцевого індексу
const phrase = 'I love coding';
console.log(phrase.slice(2)); // Виведе: 'love coding' (від 2 до кінця)
*/
